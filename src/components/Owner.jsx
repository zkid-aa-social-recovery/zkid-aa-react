...
// import { zkidAccountAbi } from "../utils/zkidAccountAbi";
...
const Owner = () => {
  ...
  //   );
  //   const depolyer = new ethers.Wallet(process.env.DEPLOYER_SK, provider);
  //   const zkidAccount = new ethers.Contract(
  //     process.env.DEMO_ZKIDACCOUNT,
  //     zkidAccountAbi,
  //     depolyer
  //   );

  //   // call contract
  //   const tx = await zkidAccount.recordNewOwner(account);
  //   await tx.wait();
  // };
    ...
    <>
      <div className="flex items-center justify-between h-screen bg-black">
        ...
        <div className="bg-gray-900 w-full h-full p-12">
          <div className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl h-full">
